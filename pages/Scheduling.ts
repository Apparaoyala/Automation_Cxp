...
export class Scheduling {
    ...
    constructor(page: Page) {
        ...
        this.PostSchedule = this.page.frameLocator('frame[name="header"]').getByRole('link', { name: 'Post Schedules', exact: true });
        ...
        this.BillBtn = this.page.frameLocator('frame[name="view"]').locator('#billStatus_label');
